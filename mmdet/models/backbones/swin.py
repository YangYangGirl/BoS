...
class SwinTransformer(BaseModule):
    ...
    def __init__(self,
        ...
        self.dropout_uncertainty = 0
        self.drop_layers = [2, 3]
        self.drop_nn = nn.Dropout(p=self.dropout_uncertainty)
    ...
    def forward(self, x):
        ...
        for i, stage in enumerate(self.stages):
            ...
            if i in self.out_indices:
                ...
                if len(self.drop_layers) > 0 and self.dropout_uncertainty > 0:
                    if i in self.drop_layers:
                        self.train()
                        out = self.drop_nn(out)
                        self.eval()
