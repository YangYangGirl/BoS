...
class IOUFCOSHead(AnchorFreeHead):
    ...
    def _init_layers(self):
        ...
        self.fc_iou = nn.Linear(self.feat_channels, num_classes)
    ...
    def forward_single(self, x, scale, stride):
        ...
        if self.centerness_on_reg:
            ...
            iou_pred = self.fc_iou(reg_feat)
        else:
            centerness = self.conv_centerness(cls_feat)
            iou_pred = self.fc_iou(cls_feat)
        ...
        return cls_score, bbox_pred, centerness, iou_pred

    @force_fp32(apply_to=('cls_scores', 'bbox_preds', 'centernesses', 'iou_preds'))
    def loss(self,
             cls_scores,
             bbox_preds,
             centernesses,
        ...
        """
        assert len(cls_scores) == len(bbox_preds) == len(centernesses) == len(iou_preds)
